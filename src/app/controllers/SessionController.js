...
module.exports = {
    ...
    async reset(req, res) {
        ...
        try {
            ...
            return res.render('session/login', { success: 'Senha atualizada! Faça o seu login', user: req.body })
        } catch (error) {
            console.error(error)
            return res.render('session/password-password', { error: 'Erro inesperado, tente novamente!', token, user: req.body })
        }
    }
}